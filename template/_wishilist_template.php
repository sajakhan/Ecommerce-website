...
if ($_SERVER['REQUEST_METHOD'] == 'POST'){
    ...
    if(isset($_POST['cart-submit'])){
      ...
      if (isset($_POST['delete-wish-submit'])){
            $deletedrecord = $Cart->deleteCartw($_POST['item_id']);
        }
}
?>
                            ...
                            <div class="col-sm-8">
                                ...
                                <div class="qty d-flex pt-2">
                                    ...
                                    <form method="post">
                                     ...
                                     <form method="post">
                                <input type="hidden" value="<?php echo $item['item_id'] ?? 0; ?>" name="item_id">
                                <button type="submit" name="delete-wish-submit" class="btn font-baloo text-danger px-3 border-right">Delete from wishlist</button>
                            </form>
